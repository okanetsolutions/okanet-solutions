...
@section('legal-content')
    ...
    <p>Para consultas sobre cookies, escribe a <a href="mailto:info@okanetsolutions.com">info@okanetsolutions.com</a>, llama al <a href="tel:+584241780659">+58 424 178 0659</a> o consulta la <a href="{{ route('privacy') }}">política de privacidad</a>. El inventario debe mantenerse actualizado con las funciones de Cloudflare que estén activas. La configuración exacta de los desafíos y las cookies de producción no se ha verificado desde esta aplicación. Las cookies o herramientas opcionales que requieran consentimiento deben permanecer desactivadas hasta disponer de un mecanismo previo adecuado.</p>
@endsection
